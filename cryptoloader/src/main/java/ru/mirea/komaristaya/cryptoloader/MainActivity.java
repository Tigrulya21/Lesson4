package ru.mirea.komaristaya.cryptoloader;
...
import ru.mirea.komaristaya.cryptoloader.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                byte [] shiper = encryptMsg(binding.editTextTextPersonName.getText().toString(), key);
                Bundle bundle = new Bundle();
